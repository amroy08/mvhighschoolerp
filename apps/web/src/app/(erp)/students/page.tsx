              ...
              {filtered.map((s) => (
                <tr key={s.id} className="hover:bg-slate-50/80 transition-colors">
                  <td className="px-6 py-4">
                    ...
                    <p className="text-[11px] text-slate-400 font-mono mt-1">{s.studentId}</p>
                  </td>
                  <td className="px-6 py-4 font-semibold text-slate-900">
                    {s.fullName}
                    <p className="text-xs text-slate-500 font-normal">{s.gender}</p>
                  </td>
                  <td className="px-6 py-4">
                    <span className="inline-flex items-center gap-1.5 text-xs font-medium text-slate-800 bg-slate-100 px-2.5 py-1 rounded-lg border border-slate-200">
